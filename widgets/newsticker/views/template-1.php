<?php
/**
 * Widget Render: Newsticker
 *
 * @package widgets/newsticker/views/template-1.php
...
<div id="elmpath-newsticker<?php echo esc_attr( $unique_id ); ?>"
     class="elmpath-newsticker elmpath-newsticker-<?php echo esc_attr( $style ); ?>">
    <span class="elmpath-newsticker-label"><?php echo esc_html( $_label ); ?></span>
    <div class="elmpath-newsticker-wrap">
        <div class="owl-carousel">
			<?php foreach ( $posts_ids as $posts_id ) : ?>
                <h3 class="elmpath-newsticker-single">
