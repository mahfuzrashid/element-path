...
class ELMPATH_Newsticker extends ELMPATH_Widget_base {

	/**
	 * Get element name.
	 */
	public function get_name() {
		return 'elmpath-newsticker';
	}
	...
	public function get_style_depends() {
		return [ 'owl-carousel', 'elmpath-newsticker' ];
	}
