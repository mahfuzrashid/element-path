 ...
 *
 * @package elements/post-grid/view/template-5
	...
	<?php if ( $wp_query->have_posts() ) : ?>
        <div class="pb-row">
			<?php while ( $wp_query->have_posts() ) : $wp_query->the_post();
                ...
                <div class="pb-col-lg-<?php echo esc_attr( $items_per_row ); ?> pb-col-md-12 pb-grid-item">
                    <div class="post-item">
                        ...
                        <div class="post-body">
                            <div class="post-meta">
			                    ...
			                    <?php printf( '<span class="post-comment"><i class="elmpath-icofont-eye"></i> %s</span>', get_comments_number( get_the_ID() ) ); ?>
                            </div>
                            <h3 class="post-title">
                            ...
                            <div class="post-footer-left">
			                    <?php printf( '<span class="post-meta-date">%s</span>', get_the_date( 'M jS, Y' ) ); ?>
                            </div>
