 ...
 *
 * @package widgets/testimonial/views/template-2.php
...
$recommended = elmpath()->get_settings_atts( 'recommended' );
        ...
        <div class="elmpath-testi-desc">
            ...
            <div class="elmpath-testi-rating">
			    ...
			    if ( !empty( $recommended ) ) {
			        printf( '<span class="elmpath-testi-rating-text">%s</span>', esc_html( $recommended ) );
                }
