 ...
 *
 * @package widgets/tribe-events-grid/views/template-1.php
                ...
                <div class="elmpath-event-item <?php echo esc_attr( $has_thumb_class ); ?>">
                    ...
                    <div class="elmpath-event-body">
						...
						<?php if ( ! empty( $show_date ) ) : ?>
                            ...
                            <span class="elmpath-event-day">
                                <?php echo esc_html( str_pad( tribe_get_start_date( null, false, 'j' ), 2, '0', STR_PAD_LEFT ) ); ?>
                            </span>
                                <span>
                                <?php echo esc_html( tribe_get_start_date( null, false, 'M' ) ); ?>
                            </span>
                            </div>
						<?php endif; ?>
